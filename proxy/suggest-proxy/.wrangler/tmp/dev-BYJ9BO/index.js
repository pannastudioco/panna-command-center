...
var src_default = {
  async fetch(request) {
    ...
    const cleanSuggestions = suggestions.filter((s) => typeof s === "string");
...
// .wrangler/tmp/bundle-wOBA0y/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wOBA0y/middleware-loader.entry.ts
